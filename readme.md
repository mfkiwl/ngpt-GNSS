...
### + Error when trying to run (any of) the installed programs (typically something like: ```atxtr: error while loading shared libraries: libngpt.so.0: cannot open shared object file: No such file or directory```)
