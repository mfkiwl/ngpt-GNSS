...
: QFrame( parent )
{
    ...
    // add vertical axis ticks for (Axis block)
    // 
    ...
    // add vertical ticks for grids (Grid)
    //
...
void
SettingsEditor::showSettings(const PlotSettings& settings)
{
    blockSignals( true );
    for ( int i = 0; i < PlotSettings::NumFlags; i++ )
    {
