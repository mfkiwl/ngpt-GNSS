/****************************************************************************
** Meta object code from reading C++ file 'settingseditor.hpp'
**
...
#error "The header file 'settingseditor.hpp' doesn't include <QObject>."
...
const QMetaObjectExtraData SettingsEditor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SettingsEditor::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_SettingsEditor,
      qt_meta_data_SettingsEditor, &staticMetaObjectExtraData }
};
